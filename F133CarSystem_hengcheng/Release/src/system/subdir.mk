...
CPP_SRCS += \
../src/system/fm_emit.cpp \
../src/system/hardware.cpp \
../src/system/reverse.cpp \
../src/system/setting.cpp \
../src/system/usb_monitor.cpp 

OBJS += \
./src/system/fm_emit.o \
./src/system/hardware.o \
./src/system/reverse.o \
./src/system/setting.o \
./src/system/usb_monitor.o 

CPP_DEPS += \
./src/system/fm_emit.d \
./src/system/hardware.d \
./src/system/reverse.d \
./src/system/setting.d \
./src/system/usb_monitor.d 
